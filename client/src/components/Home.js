    ...
    <main className="home">
      <div className="hero">
        ...
        <div className="container-header">
          <CardHeader>Cali Kulture is a London based Calisthenics community and academy, offering adult and children classes, workshops and competitions.</CardHeader>
        </div>
      </div>
    </main>
  )
